        ...
        <header>
            <div className="container mx-auto py-7 flex justify-between" >
                <div className="flex space-x-10 items-center">
                    ...
                    {/* navBar */}
                    <nav>
                        <ul className=' hidden lg:flex items-center space-x-6 font-semibold text-26 dark:text-white'>{
                            MenuItems.map((v) => (
                ...
                <div className='flex items-center space-x-4'>
                        <button className='text-2xl' onClick={()=>bgTheme.ToggleTheme(bgTheme.theme)} >
                           { bgTheme.theme==='light'?<FaRegMoon  /> :<LuSun className='text-white'/>}
                        </button>
                        <a href="#" className='hidden lg:inline-block px-6 py-2 bg-black font-semibold dark:bg-white dark:text-black text-white rounded-4xl'>Let's Talk</a>
