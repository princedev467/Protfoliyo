...
function Home_3(props) {
    const skills = [
        ...
        { name: "JavaScript", icon: <SiJavascript className='text-yellow-400 size-12' /> },
    ...
    return (
      ...
      bg-white dark:bg-darkBg text-black dark:text-white transition">
                ...
                <div>
                    ...
                    <div className='flex mt-3 text-sm text-gray-500 space-x-3'>
                        <p className="hover:text-amber-50">
                            MongoDB
                        </p>
                        <p className="hover:text-amber-50">
                            • Express
                ...
                <div
                    ...
                    className="relative"
                >
                    <div className="absolute inset-0 blur-2xl border-4  bg-primary opacity-50 rounded-full"></div>

                    <img
                        src={Profile}
                        className="relative w-72 rounded-xl dark:shadow-3xl"
                    />
                </div>
            </section>
            <section className="py-20 px-6 md:px-16 
    bg-gray-50 dark:bg-[#0b1215] transition">
