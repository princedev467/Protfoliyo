...
function Home_3() {
    ...
    const PROJECTS = [
        ...
        },
        {
            title: "Traveller",
            tag: "Travel Website",
            desc: "A responsive travel website built using HTML and CSS, showcasing destinations, travel planning features, and a clean user interface",
            tech: ["HTML", "CSS", "Javascript","Swiper.js"],
            color: "#10B981",
            link: "https://github.com/princedev467/Traveller",
            live: "https://traveller-nine-alpha.vercel.app/",
        },
        {
            title: "Lexis AI",
            tag: "AI / NLP App",
